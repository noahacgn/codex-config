...
- On Windows PowerShell, avoid Bash-specific syntax (such as here-docs), do not pass unexpanded wildcard paths to commands, and prefer fixed-string searches (`rg -F` or `Select-String -SimpleMatch`) when patterns contain quotes or backslashes.
